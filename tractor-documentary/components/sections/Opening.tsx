    ...
    <section id="summary" className="section">
      <div className="wrap">
        <SectionHeader
          ...
          title="A field-ready companion — built for Robert, Sarah, and Carlos."
        />
        ...
        <div className="relative flex items-center px-[6vw] pt-[12vh] pb-8 lg:sticky lg:top-0 lg:h-screen lg:px-0 lg:py-0">
          <div className="lg:pl-[8vw] lg:pr-12">
            ...
            <h2 className="h-section">
              ...
              <br />
              <span className="amber">with a light nobody can read.</span>
            </h2>
            <motion.div
    ...
    <section id="context" className="section">
      <div className="wrap">
        <SectionHeader
          index="01"
          kicker="The Field"
          title="The world the app actually lives in."
          lead={context.lead}
        />
      </div>
      ...
      <div ref={ref} className="relative mt-16 h-[44vh] overflow-hidden sm:h-[60vh]">
        ...
        <div className="absolute inset-0 grid place-items-center">
          ...
          >
            Farmers think in seasons and jobs.{" "}
            <span className="amber">The app spoke in codes.</span>
          </p>
        </div>
      </div>
    ...
    <section id="problem" className="section">
      <div className="wrap">
        <SectionHeader
          ...
          title={
            <>
              The app wasn&apos;t missing features.
              <br />
              It was <span className="amber">speaking the wrong language.</span>
            </>
          }
        />
        <Reveal delay={0.1}>
